...
# Include dir
find_path(UEYE_SDK_INCLUDE_DIR 
	NAMES uEye.h ueye.h
	PATHS 
...
if(CMAKE_SIZEOF_VOID_P MATCHES "8")
	find_library(UEYE_SDK_LIB
	NAMES uEye_api_64 libueye_api64.so.4.72
	HINTS 
	$ENV{UEYE_SDK_ROOT}/Develop/Lib $ENV{UEYE_SDK_ROOT}/Lib
	/usr/lib)
else()
	find_library(UEYE_SDK_LIB 
	NAMES uEye_api libueye_api
	HINTS
	$ENV{UEYE_SDK_ROOT}/Develop/Lib $ENV{UEYE_SDK_ROOT}/Lib
	/usr/lib)
endif()
